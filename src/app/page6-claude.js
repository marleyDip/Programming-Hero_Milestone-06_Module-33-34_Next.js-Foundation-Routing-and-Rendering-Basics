...
type Topic = {
  ...
  href: string;
  emoji: string;
  category: "Structure" | "Routing" | "Rendering" | "Styling" | "Data";
  color: string; // tailwind linear classes
};

const topics: Topic[] = [
  {
    title: "Next.js & Project Structure",
    description: "App Router, folder conventions, and how a Next.js project is organized.",
  ...
  },
  {
    ...
    description: "File-based routing and moving between pages with the Link component.",
    href: "/topics/routing",
    emoji: "🧭",
    category: "Routing",
  ...
  },
  {
    ...
    description: "Shared UI across routes using layout.tsx, nested at multiple levels.",
    href: "/topics/layouts",
    emoji: "🧩",
    category: "Structure",
  ...
  },
  {
    ...
    description: "Route segments like [id] that render pages based on URL params.",
  ...
  },
  {
    ...
    description: "Rendering blog posts from dynamic data using generateStaticParams.",
    href: "/blog",
    emoji: "📝",
    category: "Data",
  ...
  },
  {
    ...
    description: "Using next/image for automatic resizing, lazy loading, and formats.",
    href: "/topics/images",
    emoji: "🖼️",
    category: "Styling",
  ...
  },
  {
    ...
    description: "The 'use client' boundary and choosing the right component type.",
  ...
  },
  {
    ...
    description: "Fetching data in the browser with useEffect / SWR / React Query.",
  ...
  },
  {
    ...
    description: "A practice project: food item details rendered from a dynamic route.",
    href: "/food",
    emoji: "🍔",
    category: "Data",
...
const categories = ["All", "Structure", "Routing", "Rendering", "Styling", "Data"] as const;
...
export default function Home() {
  ...
  const toggleComplete = (href: string, e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    setCompleted((prev) => {
      ...
      <section className="relative overflow-hidden px-6 pt-24 pb-16 text-center">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-slate-300">
            A hands-on roadmap from project structure to hydration — track
          ...
          <div className="mx-auto mt-8 max-w-md">
            <div className="mb-2 flex justify-between text-sm text-slate-400">
              <span>Progress</span>
              <span>{completed.size} / {topics.length} topics</span>
            </div>
